const quotes = [
	...
	{
		quote: "실패나 좌절, 맛보고 고개 숙여도 돼. 우리는 아직 젊고 어려, 걱정 붙들어 매.",
		from: "INTRO: Never Mind, bts",
	},
	{
		quote: "이 순간은 언제든 다시 찾아오지 않아. 다시 나에게 되물어 봐, 지금 행복한가.",
		from: "INTRO: 화양연화, bts",
	},
	{
		quote: "그래도 믿고 있어. 믿기지 않지만 길을 잃는단 건, 그 길을 찾는 방법.",
		from: "Lost, bts",
	},
	{
		quote: "쓸모있어, 이 좌절도. 난 믿어, 우린 바로 가고 있어.",
		from: "Lost, bts",
	},
	{
	...
	{
		quote: "세상의 기대치와 너무 비대칭 할까봐 두려웠어. 나를 믿어줬던 모든 사람들을 배신하게 될까봐.",
		from: "Born Singer, bts",
	},
	{
		quote: "삶은 살아지는 게 아니라 살아내는 것. 그렇게 살아내다가 언젠가 사라지는 것.",
		from: "Tomorrow, bts",
	},
	{
		quote: "성공한 이유가 뭐냐고 물어보면 딱히 답을 할 게 없어. 그동안 적어도 너네보단 덜 자고 더 움직이며 컸어.",
	...
	{
		quote: "너의 길을 가라고. 단 하루를 살아도, 뭐라도 하라고. 나약함은 담아 둬.",
		from: "No more dream, bts",
	},
	{
		quote: "꿈이 뭐 거창한 거라고, 그냥 아무나 되라고. We deserve a life. 뭐가 크건 작건, 그냥 너는 너잖어.",
		from: "낙원, bts",
	},
	{
	...
	{
		quote: "내 미래를 향해 가. 저 푸른 바다와 내 헤르츠를 믿어.",
		from: "Whalien52, bts",
	},
	{
		quote: "이제 알겠어, 후회하며 늙어가는 건 break up. 나는 택했어, 조건 없는 믿음을 가지겠어.",
		from: "OUTRO: Wings, bts",
	},
	{
		quote: "괜찮아. 자, 하나 둘 셋 하면 잊어. 슬픈 기억 모두 지워. 서로 손을 잡고 웃어.",
		from: "둘!셋!, bts",
	},
	{
		quote: "니 멋대로 살어, 어차피 니거야. 애쓰지 좀 말어, 져도 괜찮아.",
		from: "불타오르네, bts",
	},
	{
		quote: "말해, 너는 강하다고. 말해, 넌 충분하다고.",
		from: "21세기 소녀, bts",
	},
];
